...
var DYNAMIC_BASE = 11287760
  , DYNAMICTOP_PTR = 6044720;
...
var wasmBinaryFile = "codecbox.wasm";
...
var ___tm_timezone = (stringToUTF8("GMT", 6044784, 4),
6044784);
...
function _pthread_attr_setschedpolicy() {
    err("missing function: pthread_attr_setschedpolicy");
    abort(-1)
}
function _pthread_attr_setscope() {
    err("missing function: pthread_attr_setscope");
    abort(-1)
}
...
var asmLibraryArg = {
    ...
    "Ga": _mktime,
    "Da": _nanosleep,
    "ra": _pthread_attr_destroy,
    "va": _pthread_attr_init,
    "ta": _pthread_attr_setschedpolicy,
    "ua": _pthread_attr_setscope,
    "sa": _pthread_create,
    "qa": _pthread_join,
    "p": _round,
    "r": _roundf,
